# Pinned to an exact patch and kept identical to Dockerfile.security-scan, so
# the security scan runs against the same standard library that ships. Bump all
# three together.
