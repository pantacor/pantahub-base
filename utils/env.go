...
const (
	...
	// EnvPantahubAuthorizeJWTTimeoutMinutes JWT timeout for authorize tokens in Minutes
	// default: 1920 (32 hours)
	EnvPantahubAuthorizeJWTTimeoutMinutes = "PANTAHUB_AUTHORIZE_JWT_TIMEOUT_MINUTES"
