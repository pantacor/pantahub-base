    ...
    "paths": {
        ...
        "/auth/login": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Login credentials (required if not using Basic Auth)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.MFALoginRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/login/mfa/totp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pending token and authenticator code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnLoginRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnOptionsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/login/mfa/webauthn/finish": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Pending token, session id and browser assertion response",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnLoginFinishRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/login/webauthn/finish": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Session id and browser assertion response",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.PasskeyLoginFinishRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.MFAStatusResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.MFASudoCodeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.SudoResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/auth/mfa/reauth/webauthn/finish": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "Session id and browser assertion",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnSudoFinishRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/mfa/recovery/regenerate": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Fresh-auth proof",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.MFAPasswordRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.RecoveryCodesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.TOTPEnrollResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/mfa/totp/confirm": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "First authenticator code",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.TOTPConfirmRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/mfa/webauthn/credentials/{id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnRenameRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnCredentialInfo"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/auth/mfa/webauthn/register": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Fresh-auth proof and credential kind",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnRegisterRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/mfa/webauthn/register/finish": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Session id, label and browser credential response",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnRegisterFinishRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/authmodels.WebauthnRegisterFinishResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/authmodels.TokenRefreshRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/devices.patchDeviceTokenRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "authmodels.MFAStatusResponse": {
            ...
            "properties": {
                ...
                "totp": {
                    "$ref": "#/definitions/authmodels.MFAStatusTOTP"
                },
                "webauthn": {
                    "type": "array",
                    "items": {
        ...
        "authmodels.PasskeyLoginFinishRequest": {
            "type": "object",
            "properties": {
                "credential": {
                    "type": "object"
        ...
        "authmodels.RecoveryCodesResponse": {
            "type": "object",
            "properties": {
                "recovery_codes": {
                    "type": "array",
        ...
        "authmodels.TokenRefreshRequest": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string"
        ...
        "authmodels.WebauthnCredentialInfo": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "authmodels.WebauthnLoginFinishRequest": {
            "type": "object",
            "properties": {
                "credential": {
                    "type": "object"
        ...
        "authmodels.WebauthnLoginRequest": {
            "type": "object",
            "properties": {
                "mfa_token": {
                    "type": "string"
        ...
        "authmodels.WebauthnOptionsResponse": {
            "type": "object",
            "properties": {
                "options": {
                    "type": "object"
        ...
        "authmodels.WebauthnRegisterFinishRequest": {
            "type": "object",
            "properties": {
                "credential": {
                    "type": "object"
        ...
        "authmodels.WebauthnRegisterFinishResponse": {
            "type": "object",
            "properties": {
                "credential": {
                    "$ref": "#/definitions/authmodels.WebauthnCredentialInfo"
        ...
        "authmodels.WebauthnRegisterRequest": {
            "type": "object",
            "properties": {
                "passkey": {
                    "type": "boolean"
        ...
        "authmodels.WebauthnRenameRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "authmodels.WebauthnSudoFinishRequest": {
            "type": "object",
            "properties": {
                "credential": {
                    "type": "object"
        ...
        "devices.patchDeviceTokenRequest": {
            "type": "object",
            "properties": {
                "default-user-meta": {
                    "type": "object",
        ...
        "trailmodels.Trail": {
            ...
            "properties": {
                ...
                "last-insync": {
                    "description": "Admins   []string ` + "`" + `json:\"admins\"` + "`" + `   // XXX: maybe this is best way to do delegating device access....",
                    "type": "string"
                },
                "last-touched": {
                    "type": "string"
